...
export const dictionaries = {
  ko: {
    ...
    codeLab: {
      eyebrow: "안전한 코드 실습",
      heading: "수리 설정",
      description: "설정을 바꾸면 왼쪽 삭제 창과 아래 코드가 즉시 바뀝니다.",
    ...
    history: {
      ...
      empty: "검사를 실행하면 삭제 창의 증거가 여기에 저장됩니다.",
  ...
  en: {
    ...
    codeLab: {
      ...
      description: "Each setting immediately updates the delete dialog and the code below.",
    ...
    history: {
      ...
      empty: "Run a check to preserve evidence from the delete-dialog preview.",
